      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: '#334155', fontSize: 11 }}>{SYSTEM_NAME}</span>
          </div>
          ...
          {step === 'pin' && (
            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{
                ...
                <span style={{ color: '#94a3b8', fontSize: 12 }}>{pendingSession?.location}</span>
              </div>

              {/* Employee selector */}
              <div>
                <label style={{ display: 'block', color: '#64748b', fontSize: 11, fontWeight: 600, marginBottom: 6, letterSpacing: 0.5 }}>
                  SELECT EMPLOYEE
                </label>
                <select
                  value={selectedEmp}
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6, color: '#475569', fontSize: 13, cursor: 'pointer',
        ...
        <div style={{
          ...
          <p style={{
            ...
            color: '#334155', fontSize: 12, letterSpacing: 0.3,
          }}>
